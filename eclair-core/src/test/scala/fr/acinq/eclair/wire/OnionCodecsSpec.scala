...
class OnionCodecsSpec extends FunSuite {
  ...
  test("encode/decode fixed-size (legacy) per-hop payload") {
    val testCases = Map(
      OnionForwardInfo(ShortChannelId(0), 0, 0) -> hex"00 0000000000000000 0000000000000000 00000000 000000000000000000000000",
      OnionForwardInfo(ShortChannelId(42), 142000, 500000) -> hex"00 000000000000002a 0000000000022ab0 0007a120 000000000000000000000000",
      OnionForwardInfo(ShortChannelId(561), 1105, 1729) -> hex"00 0000000000000231 0000000000000451 000006c1 000000000000000000000000"
    )
